                    ...
                    @forelse ($notificaciones as $notificacion)
                        <div class="p-5 border border-gray-200 lg:flex lg:justify-between lg:items-center">
                            ...
                            <div class="mt-5 lg:mt-0">
                                <a href="#" class="bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-xl">Ver
                                    Candidatos
                                </a>
                            </div>
                        </div>
                    @empty
                        <p class="text-center text-gray-600">no hay notificaciones para mostrar</p>
                    @endforelse
                </div>
            </div>
        </div>
